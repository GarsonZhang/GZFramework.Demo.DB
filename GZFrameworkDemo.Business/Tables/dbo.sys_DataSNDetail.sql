...
GO
EXEC sp_addextendedproperty N'MS_Description', '单据号码表', 'SCHEMA', N'dbo', 'TABLE', N'sys_DataSNDetail', NULL, NULL
GO
EXEC sp_addextendedproperty N'MS_Description', '单据标识', 'SCHEMA', N'dbo', 'TABLE', N'sys_DataSNDetail', 'COLUMN', N'DocCode'
GO
